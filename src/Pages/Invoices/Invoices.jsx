...
export default function Invoices() {
  ...
  return (
    <>
      <Typography sx={{ color: theme.palette.info.main, fontSize: 26, fontWeight: 'bold', textTransform: 'uppercase', mb: 0.5 }}>Invoices</Typography>
      <Typography sx={{ fontSize: 13, mb: 5, letterSpacing: 1 }}>List Of Invoices Balances</Typography>
